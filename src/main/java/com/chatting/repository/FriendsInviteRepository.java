...
public interface FriendsInviteRepository extends CrudRepository<FriendsInvite, Long> {
    ...
    //보낸 이력 조회
    FriendsInvite findByRequestUserIdAndResponseUserId(String requestUserId, String responseUserId);
    ...
    List<FriendsInvite> findByResponseUserId(String responseUserId);
}
